...
public class ItemBuilder {
    ...
    public static String unicode(String unicodeKey) {
        int codePoint = Integer.parseInt(unicodeKey.substring(2), 16);
    ...
    public ItemBuilder cmd(Integer CustomModelData) {
        return meta(meta -> meta.setCustomModelData(CustomModelData));
    }
